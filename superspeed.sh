...
preinfo() {
	echo "———————————————————SuperSpeed 李哥 全面测速版——————————————————"
	echo "       bash <(curl -Lso- https://raw.githubusercontent.com/492048653/superspeed/master/superspeed.sh)"
	echo "       全部节点列表:  https://git.io/superspeedList"
	echo "       节点更新: 2020/12/09  | 脚本更新: 2020/12/09"
	echo "——————————————————————————————————————————————————————————"
}
